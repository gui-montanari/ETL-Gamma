...
"""
Módulo de transformação de dados para o KPI de Fechamento de Comissão (meses passados).

Este módulo contém funções para preparar os dados extraídos para o carregamento.
"""
...
def prepare_fechamento_dataset(df_fechamento, mes_referencia):
    ...
    try:
        ...
        df_final['is_current_month'] = False  # Este é um fechamento de mês passado
